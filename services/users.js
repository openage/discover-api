...
const populate = 'organization tenant preferences.interests'
...
const set = async (model, entity, context) => {
    ...
    if (model.preferences) {
        ...
        entity.preferences.age = entity.preferences.age || {}
        entity.preferences.age.start = model.preferences.age.start || entity.preferences.age.start
        entity.preferences.age.end = model.preferences.age.end || entity.preferences.age.end
        entity.preferences.gender = model.preferences.gender || entity.preferences.gender

        if (model.preferences.coordinates && model.preferences.coordinates.length) {
            entity.preferences.coordinates = model.preferences.coordinates
        }

        if (model.preferences.interests && model.preferences.interests.length) {
            entity.preferences.interests = []
            for (const item of model.preferences.interests) {
                entity.preferences.interests.push(await interests.get(item, context))
            }
        }
    }
}
